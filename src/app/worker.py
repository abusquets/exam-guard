...
class Worker:
    ...
    async def _check_current_students(self) -> None:
        ...
        to_execute = [monitor.execute() for monitor in self._current_students_register.values()]
    ...
    async def run_main(self) -> None:
        while True:
            ...
            await self._check_current_students()
